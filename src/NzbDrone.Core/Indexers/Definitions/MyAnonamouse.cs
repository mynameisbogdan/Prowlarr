...
namespace NzbDrone.Core.Indexers.Definitions
{
    ...
    public class MyAnonamouseSettings : NoAuthTorrentBaseSettings
    {
        ...
        [FieldDefinition(7, Type = FieldType.Select, Label = "Use Freeleech Wedges", SelectOptions = typeof(MyAnonamouseFreeleechWedgeAction), HelpText = "Use freeleech wedges to make grabbed torrents personal freeleech")]
